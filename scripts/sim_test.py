...
class Sim:
    ...
    def update_visited(self):
        ...
        for tf in self.frames:
            tf_ = self.tf_buffer.can_transform(self.global_frame, tf, rospy.Time(0), rospy.Duration(2.0))
            trans = self.tf_buffer.lookup_transform(self.global_frame, tf, rospy.Time(0), rospy.Duration(0.3))
